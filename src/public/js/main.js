...
import {LeaderboardComponent} from './components/Leaderboard/Leaderboard.ts';
import {LoginComponent} from './components/Login/Login.ts';
import {MenuComponent} from './components/Menu/Menu';
import {PlayComponent} from './components/Play/Play.ts';
import {ProfileComponent} from './components/Profile/Profile.ts';
import {RegistrationComponent} from './components/Registration/Registration.ts';
